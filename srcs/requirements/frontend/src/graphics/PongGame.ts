...
export class PongGame {
  ...
  private scoreCallback:
    | ((player1Score: number, player2Score: number) => void)
    | null = null;
  ...
  public pause(): void {
    ...
    console.log("Paused", this.gameLoop);
  ...
  public setScoreCallback(
    callback: (player1Score: number, player2Score: number) => void
  ): void {
  ...
  private checkScoring(): void {
    ...
    if (this.ball.isOutOfBounds()) {
      ...
      console.log("Player 1 scored:", this.player1Score);
      console.log("Player 2 scored:", this.player2Score);
